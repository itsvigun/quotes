 ...
 */
final class Version20200912135154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote ADD author_id INT');
        $this->addSql('ALTER TABLE quote ADD type_id INT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_6B71CBF4C54C8C93');
        $this->addSql('ALTER TABLE quote DROP author_id');
        $this->addSql('ALTER TABLE quote DROP type_id');
    }
}
